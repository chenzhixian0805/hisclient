  ...
  <div class="wrapper">
    ...
    <div class="info">
      ...
      <el-table :data="departments" style="width: 100%; margin-top: 20px" stripe border>
        <el-table-column prop="name" label="科室名称" width="150" align="center" />
...
export default {
  setup() {
    const departments = ref([
      {
        name: "普外科",
        description: "主要治疗普通外科疾病，如外伤、疝气等。",
        doctor: null,
        roomNumber: "A201",
        director: "王医生",
        schedule: [
      ...
      {
        name: "神经外科",
        description: "主要治疗神经外科疾病，如脑瘤、脊柱畸形等。",
        doctor: null,
        roomNumber: "C401",
        director: "李医生",
        schedule: [
      ...
      {
        name: "心胸外科",
        description: "主要治疗心胸外科疾病，如心脏病、肺癌等。",
        doctor: null,
        roomNumber: "D501",
        director: "赵医生",
        schedule: [
    ...
    const getDoctorSchedule = doctorName => {
      ...
      if (department) {
        const schedule = department.schedule.find(
          schedule => schedule.doctor === doctorName
        );
        if (schedule) {
